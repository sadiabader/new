                      ...
                      <div class="collapse navbar-collapse" id="cat-nav-mega">
                          <ul class="nav navbar-nav">
                              <li class="dropdown menu-large">
                                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Cosmetics <i class="fa fa-angle-down"></i></a>
                                          ...
                                          <div class="">
                                              <div class="mega">
                                                  ...
                                                  <ul>
                                                      ...
                                                      <li><a href="">Whitening Cream</a></li>
                              ...
                              <li class="dropdown menu-large">
                                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Jewelery <i class="fa fa-angle-down"></i></a>
                                  <ul class="dropdown-menu megamenu" role="menu">
                                      <li>
                                          <div class="">
                                              <div class="mega">
                                                  ...
                                                  <ul>
                                                      <li><a href="">Bridal Jewelery</a></li>
                                                      <li><a href="">Casual Jewelery</a></li>
                                                      <li><a href="">Simple Jewelery</a></li>
                              ...
                              <li><a href="contact.php">Bangles </a></li>
                              <li><a href="contact.php">Glowing cream </a></li>
